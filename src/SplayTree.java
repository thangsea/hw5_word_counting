...
public class SplayTree {
    ...
    public static void test () {
        ...
        splaytree.insert(new MyString("Happy"));
        splaytree.insert(new MyString("weird"));
        splaytree.insert(new MyString("sad"));
        splaytree.insert(new MyString("Acropolis"));
        splaytree.insert(new MyString("ZZZZZZYY"));
        splaytree.printTreeDepth(splaytree.root, 0);
    }
